# -*- encoding: utf-8 -*-
# stub: github-pages 101 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jekyll-sitemap>, ["= 0.11.0"])
      s.add_runtime_dependency(%q<jekyll-feed>, ["= 0.7.2"])
      ...
      s.add_dependency(%q<jekyll-sitemap>, ["= 0.11.0"])
      s.add_dependency(%q<jekyll-feed>, ["= 0.7.2"])
